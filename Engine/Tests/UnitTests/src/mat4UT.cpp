...
namespace mat4UT
{
	...
	TEST(Matrix4, Inverse)
	{
		...
		EXPECT_EQ(m1[3], 1.f / 3.f);
		EXPECT_EQ(m1[6], 1.f / 6.f);
		EXPECT_EQ(m1[10], 1.f / 10.f);
		EXPECT_EQ(m1[15], 1.f / 15.f);
	}
	...
	////	TheCoolerMath::mat4 m1C = m1.Comatrix();
	...
	//	for (int i = 0; i < 16; ++i)
	//	{
	//		EXPECT_EQ(translate[i], translateg[i]);
	//	}
	//}
	...
	//	for (int i = 0; i < 16; ++i)
	//	{
	//		EXPECT_EQ(perspective[i], perspectiveg[i]);
	//	}
	//}

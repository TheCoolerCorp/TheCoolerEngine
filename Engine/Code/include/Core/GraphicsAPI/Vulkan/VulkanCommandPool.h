	...
	namespace Core
	{
		namespace GraphicsAPI
		{
			...
			public:
				...
				static void RecordCommandBuffer(VkCommandBuffer a_commandBuffer, uint32_t a_imageIndex, RHI::IRenderPass* a_renderPass, RHI::ISwapChain* a_swapChain, RHI::IGraphicPipeline* a_graphicPipeline);
			...
			private:
				...
				CommandBuffers* m_commandBuffersStruct = nullptr;
			};
		}
	}
}

	...
	namespace Core
	{
		...
		namespace RHI
		{
			...
			public:
				...
				ENGINE_API virtual void Create(ILogicalDevice* a_logicalDevice, IRenderPass* a_renderPass, std::array<IShader*, 2> a_vertFragShaders, std::vector<IShader*> a_additionalShaders = {}) = 0;

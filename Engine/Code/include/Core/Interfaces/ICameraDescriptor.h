	...
	namespace Core
	{
		...
		namespace RHI
		{
			...
			public:
				...
				ENGINE_API virtual void Create(ILogicalDevice* a_logicalDevice, IPhysicalDevice* a_physicalDevice, IGraphicPipeline* a_pipeline, IDescriptorPool* a_descriptorPool, ICommandPool* a_commandPool, Math::mat4 a_vp, int a_size) = 0;

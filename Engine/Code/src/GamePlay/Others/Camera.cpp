...
namespace Engine
{
	namespace GamePlay
	{
		...
		void Camera::Create(Core::Renderer* a_renderer)
		{
			...
			m_descriptor->Create(a_renderer->GetLogicalDevice(), a_renderer->GetUnlitPipeline(), Core::RHI::Camera, 1, 1, {1}, 1, { 1 }, { Core::RHI::DescriptorSetDataType::DESCRIPTOR_SET_TYPE_UNIFORM_BUFFER });
